...
export const getCatalogCategories  = ()         => api.get('/pos/catalog-categories/')
export const createCatalogCategory = (data)     => api.post('/pos/catalog-categories/', data)
export const updateCatalogCategory = (id, data) => api.patch(`/pos/catalog-categories/${id}/`, data)
export const deleteCatalogCategory = (id)       => api.delete(`/pos/catalog-categories/${id}/`)
export const getMenuGroups         = (params)   => api.get('/pos/menu-groups/', { params })
export const createMenuGroup       = (data)     => api.post('/pos/menu-groups/', data)
export const updateMenuGroup       = (id, data) => api.patch(`/pos/menu-groups/${id}/`, data)
export const deleteMenuGroup       = (id)       => api.delete(`/pos/menu-groups/${id}/`)
export const getMenuItems          = (params)   => api.get('/pos/menu-items/', { params })
export const createMenuItem        = (data)     => api.post('/pos/menu-items/', data)
export const updateMenuItem        = (id, data) => api.patch(`/pos/menu-items/${id}/`, data)
export const deleteMenuItem        = (id)       => api.delete(`/pos/menu-items/${id}/`)
export const getItemVariants       = (params)   => api.get('/pos/item-variants/', { params })
export const createItemVariant     = (data)     => api.post('/pos/item-variants/', data)
export const updateItemVariant     = (id, data) => api.patch(`/pos/item-variants/${id}/`, data)
export const deleteItemVariant     = (id)       => api.delete(`/pos/item-variants/${id}/`)
// POS — Items
